...
const FAQS: FAQ[] = [
  ...
  },
  {
    ...
    answer:
      'Most mission types price off the standard ladder: $9 for 5 respondents, $39 for 25, $149 for 100, $299 for 250, $499 for 500, $899 for 1,000 and $1,099 for 1,250. Counts in between are priced off the same ladder. Two types are priced on their own terms. Brand Lift splits the sample across exposed and control cells, so it starts at 100 respondents ($150) and runs $300 at 200, $600 at 500. Creative Attention is not priced by respondent count at all: it is a flat charge per creative, $19 for an image and $49 for a video, one creative per mission. Self-serve studies go up to 1,250 respondents; above that we scope the study with you rather than sell it on the site. Targeting depth adds a per-respondent surcharge, capped per category (professional $1.50, technographic $1.00, financial $1.00, city targeting $1.00) - demographics are free, and screening adds $0.50 per respondent. Every mission includes 10 questions; each extra question is $5. Promo codes apply at checkout. The full breakdown shows on the launch screen before any payment.',
  },
  {
    category: 'Pricing',
