      ...
      <div className="max-w-5xl mx-auto px-4 sm:px-6">
        ...
        <section className="rounded-2xl border border-white/10 bg-white/5 backdrop-blur-xl p-6 md:p-8 mb-12">
          ...
          <ul className="space-y-3 text-white/80 text-base leading-relaxed">
            ...
            <li className="flex gap-3"><Check className="w-5 h-5 text-primary shrink-0 mt-0.5" /><span><strong className="text-white">Pricing model:</strong> VETT charges {SELF_SERVE_RANGE} per mission, no subscription. Typeform is $39-$129/month + an Enterprise tier.</span></li>
