      ...
      <div className="max-w-5xl mx-auto px-4 sm:px-6">
        ...
        <section className="rounded-2xl border border-white/10 bg-white/5 backdrop-blur-xl p-6 md:p-8 mb-12">
          ...
          <ul className="space-y-3 text-white/80 text-base leading-relaxed">
            ...
            <li className="flex gap-3"><Check className="w-5 h-5 text-primary shrink-0 mt-0.5" /><span><strong className="text-white">Cost:</strong> VETT {SELF_SERVE_RANGE} per mission. Agency studies $5K-$50K+ depending on scope, sample, and polish.</span></li>
